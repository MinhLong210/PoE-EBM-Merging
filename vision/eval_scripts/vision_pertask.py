...
def run_BIG_function():
    ...
    set_seed(BIGSEED)
    # Get config
    ###### Merge LoRA-Finetuned models
    # CONFIG_NAME = 'vitB_r16_knots_ties'
    # CONFIG_NAME = 'vitB_r16_knots_dare_ties'
    # CONFIG_NAME = 'vitB_r16_dare_ties'
    # CONFIG_NAME = 'vitB_r16_tv'
    # CONFIG_NAME = 'vitB_r16_cauchyebm'
    
    # CONFIG_NAME = 'vitL_r16_knots_ties'
    # CONFIG_NAME = 'vitL_r16_knots_dare_ties'
    # CONFIG_NAME = 'vitL_r16_tv'
    # CONFIG_NAME = 'vitL_r16_dare_ties'
    # CONFIG_NAME = 'vitL_r16_cauchyebm'

    ##### Merge Fully-Finetuned models
    CONFIG_NAME = 'FFT.vitB_cauchyebm'
    # CONFIG_NAME = 'vitB_r16_knots_ties'
    # CONFIG_NAME = 'vitB_r16_knots_dare_ties'
    # CONFIG_NAME = 'FFT.vitB_r16_dare_ties'
    # CONFIG_NAME = 'FFT.vitB_r16_tv'

    # CONFIG_NAME = 'FFT.vitL_cauchyebm'
    # CONFIG_NAME = 'FFT.vitL_r16_knots_ties'
    # CONFIG_NAME = 'vitL_r16_knots_dare_ties'
    # CONFIG_NAME = 'FFT.vitL_r16_tv'
    # CONFIG_NAME = 'FFT.vitL_r16_dare_ties'
    # CONFIG_NAME = 'FFT.vitL_r16_doge_ta'
    ...
    with torch.no_grad():
        ...
        # if CONFIG_NAME.startswith("FFT"):
        #     pretrained_model = deepcopy(config['models']['new'].visual) # we deal with visual tower only
        #     pretrained_sd = pretrained_model.state_dict()
        #     models = []
        #     for model in config['models']['bases']:
        #         model_sd = model.state_dict()
        #         task_vector = {}

        #         for k in pretrained_sd:
        #             task_vector[k] = model_sd[k] - pretrained_sd[k]

        #         models.append(task_vector)
        ...
        if CONFIG_NAME.startswith("FFT"):
            Merge = MergeClass(
                    deepcopy(models), 
                    pretrained_model=deepcopy(config['models']['new'].visual), 
